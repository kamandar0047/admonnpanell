...
namespace Front_Back.Areas.AdminPanel.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsDeleted,Deleted")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsDeleted,Deleted")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
